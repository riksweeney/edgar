...
OBJS     += apple.o item.o crate.o status.o enemies.o hud.o random.o decoration.o
...
ED_OBJS  += apple.o item.o crate.o status.o cursor.o enemies.o hud.o random.o decoration.o
PROG      = edgar
ED_PROG   = mapeditor
CXX       = gcc
