...
OBJS     += weak_wall.o switch.o line_def.o boulder_boss.o trigger.o coal.o music.o
...
ED_OBJS  += weak_wall.o switch.o line_def.o boulder_boss.o trigger.o coal.o music.o
PROG      = edgar
ED_PROG   = mapeditor
CXX       = gcc
