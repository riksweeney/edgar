...
CFLAGS    = -Wall -pedantic -Werror -DVERSION=$(VERSION) -DRELEASE=$(RELEASE) -DDEV=$(DEV) -DINSTALL_PATH=$(INSTALL_PATH) -DUNIX
...
OBJS     += spider.o rock_pile.o beetle.o grub.o grub_boss.o save_point.o shrub.o projectile.o load_save.o
OBJS     += compress.o
...
ED_OBJS  += spider.o rock_pile.o beetle.o grub.o grub_boss.o save_point.o shrub.o projectile.o load_save.o
ED_OBJS  += compress.o
PROG      = edgar
ED_PROG   = mapeditor
CXX       = gcc
