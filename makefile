...
OBJS     += spider.o rock_pile.o beetle.o grub.o grub_boss.o save_point.o shrub.o projectile.o
...
ED_OBJS  += spider.o rock_pile.o beetle.o grub.o grub_boss.o save_point.o shrub.o projectile.o
PROG      = edgar
ED_PROG   = mapeditor
CXX       = gcc
