...
OBJS     += main_menu.o widget.o borgan.o menu.o options_menu.o npc.o gib.o heart_container.o action_point.o
OBJS     += falling_platform.o spitting_plant.o red_grub.o
...
ED_OBJS  += main_menu.o widget.o borgan.o menu.o options_menu.o npc.o gib.o heart_container.o action_point.o
ED_OBJS  += falling_platform.o spitting_plant.o red_grub.o
PROG      = edgar
ED_PROG   = mapeditor
CXX       = gcc
